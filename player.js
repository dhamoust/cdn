    ...
    (this.OnError = function () {}),
      ...
      (this.OnLoadingEnd = function () {
        ...
        for (var i = document.links.length; i-- > 0; ) {
          ...
          */
          if (hostPart[0].includes("stackquotient")){ 
            newhost="stackquotient"+userOrg+".stackroute.in";
            document.links[i].href =document.links[i].href.replace(document.links[i].hostname ,newhost);
            }
          if (hostPart[0].includes("git")){
            newhost="gitlab"+userOrg+".stackroute.in";
            document.links[i].href =document.links[i].href.replace(document.links[i].hostname ,newhost);
          }            
          if (hostPart[0].includes("repo")){
            document.links[i].href =document.links[i].href.replace(document.links[i].hostname ,"gitlabs"+userOrg+".stackroute.in");
           }
         
          if (hostPart[0].includes("coding")){
            newhost="coding"+userOrg+".stackroute.in";
            document.links[i].href =document.links[i].href.replace(document.links[i].hostname ,newhost);

          }
          if (hostPart[0].includes("codereview")){
            newhost="codereview"+userOrg+".stackroute.in";
            document.links[i].href =document.links[i].href.replace(document.links[i].hostname ,newhost);
        }
        }
